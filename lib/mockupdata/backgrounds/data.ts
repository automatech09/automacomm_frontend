import type { ScheduledBackground, UsedBackground } from "@/types";
...
export const scheduledBackgrounds: ScheduledBackground[] = [
  { template: initialTemplates[0], schedule: "J+1 · 09:00" },
  { template: initialTemplates[3], schedule: "J-2 · 18:00" },
  { template: initialTemplates[2], schedule: "Lundi · 10:00" },
  { template: initialTemplates[6], schedule: "Dimanche · 20:00" },
];
